/* :name = Translatability Assessment :description =Download langauge assets for a specific container and language pair
 *
 *  @version: 0.0.1
...
def file_list = "file_list.txt"
def url_to_file_list = domain + "Rules/" + file_list
